...
for (const { key, name } of filteredVideos) {
    ...
    videoCard.innerHTML = `
        <iframe width="500" height="294" src="https://www.youtube.com/embed/${key}?&theme=dark&color=white&rel=0" frameborder="0" allowfullscreen="true" title="${name}" class="img-cover" loading="lazy"></iframe>
    `;
...
const addSuggestedMovies = function({results: movieList},title){
    ...
    <div class="title-wrapper">
    <h3 class="title-large">You My Also Like</h3>
   </div>
   <div class="slider-list">
    <div class="slider-inner"></div>
   </div>
    ...
    for (const movie of movieList) {
        try {
            ...
            if (!sliderInner) {
                throw new Error("Slider inner element not found.");
            }
